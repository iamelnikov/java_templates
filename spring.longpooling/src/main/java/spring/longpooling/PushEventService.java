...
public class PushEventService {
	...
	private static Long eventInterval = 10000L;
	...
	public PushEventService() {
		...
		this.generator = new Thread(new EventGeneratorRunnable(this.eventSet));
	}
	...
	private static class EventGeneratorRunnable implements Runnable {
		...
		public EventGeneratorRunnable(Set<PushEvent> eventSet) {
